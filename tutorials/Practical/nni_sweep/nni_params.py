...
search_space = {
    ...
    'ticker_list': {'_type': 'choice', '_value': ['TECH_20_TICKER']},  # TECH_20_TICKER, DOW_30_TICKER, CHINESE_STOCK_TICKER, NAS_100_TICKER, SP_500_TICKER
    ...
    'ent_coef': {'_type': 'choice', '_value': [0.01,]},
}